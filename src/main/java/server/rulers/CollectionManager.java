...
public class CollectionManager {
    ...
    private final JSONparser jasoNparser;
    private final ArrayDeque<String> logStack = new ArrayDeque<>();

    public CollectionManager(JSONparser jasoNparser) {
        this.lastInitTime = null;
        this.lastSaveTime = null;
        this.jasoNparser = jasoNparser;
    }
    ...
    public void saveCollection() {
        ...
        jasoNparser.writeCollection(collection);
    ...
    public boolean loadCollection() {
        routes.clear();
        jasoNparser.readCollection(collection);
